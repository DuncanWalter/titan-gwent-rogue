...
function createDispatch(store: InternalStore, rawDispatch: RawDispatch) {
...
function createPeek(store: InternalStore) {
...
export function createStore(...middlewares: Middleware[]): InternalStore {
  const store = {
